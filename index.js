...
setInterval(() => {
    if (userConnected === "Utilisateur 1") {
        fetch('https://68147b4b225ff1af1628f9c4.mockapi.io/Messaging/2', {
            ...
            .then(data => {
                if (data.state === "send") {
                    document.getElementById("body").innerHTML += `<p style="border:none; background-color:blue; color:white; padding:10px; border-radius:10px; margin-right:100px; margin-top:0px; ">${data.message}</p>`
                    setTimeout(() => {
                        fetch("https://68147b4b225ff1af1628f9c4.mockapi.io/Messaging/2", {
                                method: "PUT",
                                headers: { 'Content-Type': "application/json" },
    ...
    if (userConnected === "Utilisateur 2") {
        fetch(`https://68147b4b225ff1af1628f9c4.mockapi.io/Messaging/1`, {
            ...
            .then(data => {
                if (data.state === "send") {
                    document.getElementById("body").innerHTML += `<p style="border:none; background-color:blue; color:white; padding:10px; border-radius:10px; margin-right:100px;">${data.message}</p>`
                    setTimeout(() => {
                        fetch("https://68147b4b225ff1af1628f9c4.mockapi.io/Messaging/1", {
                                method: "PUT",
                                headers: { 'Content-Type': "application/json" },
    ...
    if (userConnected === "Utilisateur 1" && userConnected !== 'Utilisateur 2') {
        ...
        fetch('https://68147b4b225ff1af1628f9c4.mockapi.io/Messaging/1', {
            ...
            .then(data => {
                ...
                document.getElementById("body").innerHTML += `<p style="border:none; background-color:green; color:white; padding:10px; border-radius:10px; margin-left:100px;">${data.message}</p>`
